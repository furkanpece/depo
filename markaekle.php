...
'markaadi' => $kategoriadi,
        ...
        swal("Başarılı", "Ekleme başarılı şekilde gercekleşti", "success").then((value)=>{ window.location.href = "markalar"});
        </script>
        ';
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                               <form action="markaekle.php" method="POST">
                                   
 <div class="row">                              
        <div class="col-md-12">                       
            <div class="form-group">
                 <label class="control-label">Marka Adı</label>
                    <input type="text" name="markaadi"  id="ad" required class="form-control" placeholder="Marka Adı"  >
            </div>
        </div>                             
 </div>                                 
