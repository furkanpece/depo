...
<td><img class="g100" width="100" height="200" src="<?= $sonuc['resmi']?>" alt="image profile"></td>
...
<button  type="button" data-toggle="modal" title="Düzenle" data-target="#goster" data-id="<?= $sonuc['id']?>" id="fatura" class="btn btn-icon btn-round btn-primary" data-original-title="Göster">
                                                      ...
                                                      <button  type="button" data-toggle="tooltip" title="Düzenle" class="btn btn-icon btn-round btn-warning" data-original-title="Düzenle" onclick="window.location.href='duzenleurun.php?id=<?= $sonuc["id"] ?>'">
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    window.location.href='islem/urunsil.php?id='+id;
  }
})
}
        </script>
