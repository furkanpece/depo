...
if($_POST){
    ...
    $guncelleSorgu=$baglanti->prepare("UPDATE stokgruplar SET stokgrupadi=:stokgrupadi  WHERE id=:id");
    ...
    if ($guncelle) {
        ...
        swal("Başarılı", "Güncellleme başarılı şekilde gercekleşti", "success").then((value)=>{ window.location.href = "kategori.php"});
        </script>
        ';
...
?>
 ...
 <input type="text" id="ad" class="form-control" placeholder="Depo Adı" name="stokgrupadi" value="<?= $sonuc["stokgrupadi"] ?>">
                                                  </div>
                                            </div>
